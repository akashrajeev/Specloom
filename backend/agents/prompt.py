...
MISSION
Turn the user's natural-language problem into the smallest production-safe executable system. Workflow IR describes runtime control flow; synthesized capability and software artifacts may be generated by the surrounding compiler when an external integration is missing.
