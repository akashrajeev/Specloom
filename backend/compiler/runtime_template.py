...
def _invoke_http_capability(
    ...
    auth_prefix = str(capability.get("auth_prefix") if capability.get("auth_prefix") is not None else "Bearer ")
    ...
    try:
        with urllib.request.urlopen(request, timeout=30, context=ssl.create_default_context()) as response:
            ...
            return {"status": "completed", "capability_id": capability.get("id"), "response": value}
