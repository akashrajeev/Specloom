        ...
        if user_acceptance_case_count == 0 and self.acceptance_mode == "bedrock":
            try:
                generated_acceptance = (
                    BedrockSemanticAcceptanceSynthesizer().synthesize(
                        goal=goal,
                        context=merged_context,
                        system_ir=system_ir,
                    )
                ...
                if not model_acceptance_errors and generated_acceptance.cases:
                    acceptance_review = (
                        BedrockSemanticAcceptanceReviewer().review(
                            goal=goal,
                            context=merged_context,
                            system_ir=system_ir,
                        ...
                        [
                            ...
                            PlannedFile(
                                ...
                                content=(
                                    json.dumps(
                                        {
                                            "cases": generated_acceptance.model_dump(
                                                mode="json"
                                            ),
                                            "review": (
                                                acceptance_review.model_dump(
                                                    mode="json"
                                                )
                ...
                model_acceptance_errors = [f"autonomous acceptance synthesis failed: {exc}"]
